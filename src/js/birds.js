...
const frag_shader = `
    ...
    void main() {
        ...
        gl_FragColor = vec4( 255, 255, z2, 1. );
    }
`
const vert_shader = `
...
function init() {
    ...
    scene.fog = new THREE.Fog( 0x202020, 100, 1000 );
...
function initComputeRenderer() {
    ...
    velocityVariable = gpuCompute.addVariable( 'textureVelocity', velocity_shader, dtVelocity );
